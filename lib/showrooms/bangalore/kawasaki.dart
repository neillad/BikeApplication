...
class kawasaki_bangalore extends StatelessWidget {
  const kawasaki_bangalore({Key? key}) : super(key: key);
            ...
            Row(
              children: [
                ...
                Column(
                  children: [
                    showroom_built(
                        "Khivraj KTM - Langford Road",
                        "#35/3, Ground Floor, KH Road Junction, Langford Road, Bangalore - 560025",
                        "9538092288"),
                  ],
                )
              ],
