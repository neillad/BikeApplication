...
class bmw310_bangalore extends StatelessWidget {
  const bmw310_bangalore({Key? key}) : super(key: key);
                ...
                Row(
                  children: [
                    Column(
                      children: [
                        showroom_built(
                            "Tusker Motorrad, Lavelle Road",
                            "55/2-1, Lavelle Road, Bangalore - 560001",
                            "7026767676"),
                      ],
                    ),
                    Column(
