...
class upto50k extends StatefulWidget {
  const upto50k({Key? key}) : super(key: key);

  @override
  _upto50kState createState() => _upto50kState();
}

class _upto50kState extends State<upto50k> {
  @override
