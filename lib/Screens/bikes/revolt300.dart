...
import 'package:otpapplication/showrooms/chennai/revolt.dart';
import 'package:otpapplication/showrooms/delhi/revolt.dart';
import 'package:otpapplication/showrooms/mumbai/revolt.dart';
import 'package:otpapplication/showrooms/pune/revolt.dart';

class revolt300 extends StatelessWidget {
  const revolt300({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        rich_text_build(
                            "Fuel Type               -   ", " Electric"),
                        rich_text_build("Charging Time      -  ", "  4.2 Hrs"),
                        rich_text_build("Battery Capacity   -   ", "2.7 KWH"),
                        rich_text_build(
                            "Max Power             -    ", "---------"),
                        rich_text_build(
                            "Max Torque            -    ", "---------"),
                        rich_text_build("Rated Power          -    ", "1500 W"),
                        rich_text_build(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build("Braking System     -", "     CBS"),
                    rich_text_build("Front Brake Type   - ", "    Disc"),
                    rich_text_build("Front Brake Size    -", "     240 mm"),
                    rich_text_build("Rear Brake Type    -", "      Disc"),
                    rich_text_build("Rear Brake Size     -", "      180 mm"),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build(
                        "Warranty                 -     ", "5 Years "),
                    rich_text_build(
                        "Battery Warranty   -     ", "150000km or 8 Yrs")
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  1,15,932", Colors.blue),
                        rich_text_build1(
                            "Delhi            ", "-  1,16,649", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 1,15,132", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 1,17,225", Colors.yellow),
                        ]),
                  ],
                ),
              ),
                ...
                child: ListView(
                  ...
                  children: [
                    showRooms_built(context, "Mumbai",
                        "assets/images/mumbai.png", revolt_mumbai()),
                    ...
                    showRooms_built(context, "Chennai",
                        "assets/images/chennai.png", revolt_chennai()),
                  ],
                ),
              )
            ],
