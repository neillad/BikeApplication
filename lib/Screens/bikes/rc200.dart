...
class rc200 extends StatelessWidget {
  const rc200({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        left: 30,
                        top: 25,
                        child: Image.asset('assets/images/sports/rc200.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  2,43,932", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  2,63,369", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  2,38,849", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 2,43,119", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 2,38,578", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 2,44,566", Colors.purple),
                        ]),
                  ],
                ),
              ),
