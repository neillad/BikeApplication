...
class ninja650 extends StatelessWidget {
  const ninja650({Key? key}) : super(key: key);
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  8,31,701", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  8,11,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  7,45,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 8,31,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 7,44,611", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 7,58,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
