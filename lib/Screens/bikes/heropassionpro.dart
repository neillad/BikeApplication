...
class heropassionpro extends StatelessWidget {
  const heropassionpro({Key? key}) : super(key: key);
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build("Braking System     -", "     IBS"),
                    rich_text_build("Front Brake Type   - ", "    Disc"),
                    rich_text_build("Front Brake Size    -", "     130 mm"),
                    rich_text_build("Rear Brake Type    -", "      Disc"),
                    rich_text_build("Rear Brake Size     -", "      130 mm"),
                    rich_text_build("Wheel Type             -", "      Alloy"),
                    rich_text_build("Front Wheel Size   -", "      18 inch"),
                    rich_text_build("Rear Wheel Size    -", "      18 inch"),
                    rich_text_build(
                        "Tyre Type                -", "      tubed"),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build(
                        "Brake/Tail Light     -", "     Multi Reflector"),
                    rich_text_build(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "- 84,357", Colors.blue),
                        rich_text_build1("Bangalore  ", "- 86,292", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "- 82,875", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 84,754", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 82,690", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 83,162", Colors.purple),
                        ]),
                  ],
                ),
              ),
