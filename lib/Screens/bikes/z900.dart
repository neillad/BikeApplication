...
class z900 extends StatelessWidget {
  const z900({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        ...
                        top: 25,
                        child: Image.asset(
                          'assets/images/nakedbikelogo.png',
                          height: 190,
                        ))
                  ],
                ),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "123 bhp @9,500rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "98.6 Nm @7,700rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "4"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  10,53,701", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  10,28,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-   9,47,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "-  10,52,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "-  9,43,911", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "-  9,61,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
