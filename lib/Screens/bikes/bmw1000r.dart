...
class bmw1000r extends StatelessWidget {
  const bmw1000r({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        left: 30,
                        top: 25,
                        child: Image.asset('assets/images/sports/bmw1000r.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  20,63,201", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  21,67,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  19,87,950", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 20,63,261", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 19,87,011", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 20,23,899", Colors.purple),
                        ]),
                  ],
                ),
              ),
