...
class yamahamt15 extends StatefulWidget {
  const yamahamt15({Key? key}) : super(key: key);

  @override
  _yamahamt15State createState() => _yamahamt15State();
}

class _yamahamt15State extends State<yamahamt15> {
  @override
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  1,73,701", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  1,89,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  1,68,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 1,74,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 1,70,911", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 1,71,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
