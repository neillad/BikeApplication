...
class adventure390 extends StatelessWidget {
  const adventure390({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        ...
                        top: 25,
                        child:
                            Image.asset('assets/images/adventure/ktm390.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "42.3bhp @9,000rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "37 Nm@6,7000rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "1"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  3,91,701", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "- 4,18,892", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "- 3,79,265", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 3,91,701", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 3,79,430", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 3,87,382", Colors.purple),
                        ]),
                  ],
                ),
              ),
