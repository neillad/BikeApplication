...
class duke390 extends StatelessWidget {
  const duke390({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        left: 30,
                        top: 25,
                        child: Image.asset('assets/images/naked/duke390.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "42 bhp @ 9,000 rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "37 Nm @ 7,000rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "1"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  3,45,732", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  3,69,369", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  3,34,849", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 3,45,519", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 3,34,625", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 3,41,336", Colors.purple),
                        ]),
                  ],
                ),
              ),
