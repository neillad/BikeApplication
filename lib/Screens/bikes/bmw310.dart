...
class bmw310 extends StatelessWidget {
  const bmw310({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        ...
                        top: 25,
                        child:
                            Image.asset('assets/images/adventure/bmw310.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "- 3,04,667", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", " - 3,20,342", Colors.red),
                        rich_text_build1(
                            "Delhi           ", " - 2,93,745", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 3,04,664", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 2,93,445", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 2,99,462", Colors.purple),
                        ]),
                  ],
                ),
              ),
