...
class triumpstreettriplers extends StatelessWidget {
  const triumpstreettriplers({Key? key}) : super(key: key);
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  14,11,901", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  13,80,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  12,88,950", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 14,11,261", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 12,66,811", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 12,89,931", Colors.purple),
                        ]),
                  ],
                ),
              ),
