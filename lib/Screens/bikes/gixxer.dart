...
class gixxer extends StatelessWidget {
  const gixxer({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        left: 30,
                        top: 25,
                        child: Image.asset('assets/images/naked/gixxer.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "13 bhp @ 8,000rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "13.8 Nm @6,000rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "1"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  1,45,201", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  1,55,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  1,39,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 1,42,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 1,44,911", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 1,44,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
