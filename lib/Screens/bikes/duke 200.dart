...
class duke200 extends StatelessWidget {
  const duke200({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        left: 30,
                        top: 25,
                        child: Image.asset('assets/images/naked/duke200.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "25 bhp @10,000rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "19.5 Nm @8,000rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "1"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  2,17,932", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  2,35,169", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  2,13,849", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "-  2,17,519", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 2,13,625", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 1,17,336", Colors.purple),
                        ]),
                  ],
                ),
              ),
