...
class gixxer250sf extends StatelessWidget {
  const gixxer250sf({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        ...
                        top: 25,
                        child:
                            Image.asset('assets/images/sports/gixxer250sf.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "26 bhp @9,300rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "22 Nm @7,300rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "1"),
                        rich_text_build(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build("Front Brake Size    -", "     --- mm"),
                    rich_text_build("Rear Brake Type    -", "      Disc"),
                    rich_text_build("Rear Brake Size     -", "      --- mm"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  2,16,761", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  2,30,911", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  2,09,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 2,15,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 2,14,911", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 2,16,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
