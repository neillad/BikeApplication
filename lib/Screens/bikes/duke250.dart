...
class duke250 extends StatelessWidget {
  const duke250({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        left: 30,
                        top: 25,
                        child: Image.asset('assets/images/naked/duke250.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "29 bhp @ 9,000rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "24 Nm @ 7,500rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "1"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  2,66,932", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  2,88,169", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  2,60,849", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 2,66,519", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 2,60,625", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 1,65,336", Colors.purple),
                        ]),
                  ],
                ),
              ),
