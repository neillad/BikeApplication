...
class heroxstream160r extends StatelessWidget {
  const heroxstream160r({Key? key}) : super(key: key);
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "- 1,30,848", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "- 1,39,550", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "- 1,30,875", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 1,30,754", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 1,30,690", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 1,33,162", Colors.purple),
                        ]),
                  ],
                ),
              ),
