...
class gixxersf extends StatelessWidget {
  const gixxersf({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        left: 30,
                        top: 25,
                        child: Image.asset('assets/images/sports/gixxersf.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  1,57,101", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  1,67,630", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  1,51,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 1,56,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 1,56,911", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 1,56,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    showRooms_built(context, "Chennai",
                        "assets/images/chennai.png", suzuki_delhi()),
