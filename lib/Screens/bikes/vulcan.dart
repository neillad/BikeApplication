...
class vulcan extends StatelessWidget {
  const vulcan({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        ...
                        top: 25,
                        child:
                            Image.asset('assets/images/adventure/vulcan.png'))
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "59.9bhp @7,500rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "62.4 Nm @6,600rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "2"),
                        rich_text_build(
                            "Ignition                   -    ", "Digital"),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build("Headlight Type      -", "      ------"),
                    rich_text_build(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  7,68,701", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "- 7,49,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "- 6,89,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 7,68,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 6,88,411", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 7,01,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
