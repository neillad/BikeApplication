...
class kawasakikx450 extends StatelessWidget {
  const kawasakikx450({Key? key}) : super(key: key);
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build("Front Brake Size    -", "     270 mm"),
                    rich_text_build("Rear Brake Type    -", "      Disc"),
                    rich_text_build("Rear Brake Size     -", "      2500 mm"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  8,93,501", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "- 8,96,530", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "- 9,12,550", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 9,10,561", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 8,99,811", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "-8,97,931", Colors.purple),
                        ]),
                  ],
                ),
              ),
