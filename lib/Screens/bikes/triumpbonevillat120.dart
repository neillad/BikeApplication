...
class bonevillat120 extends StatelessWidget {
  const bonevillat120({Key? key}) : super(key: key);
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  13,76,901", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  13,37,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  12,10,950", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 13,67,261", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 12,26,811", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 12,49,931", Colors.purple),
                        ]),
                  ],
                ),
              ),
