...
class z650 extends StatelessWidget {
  const z650({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        left: 30,
                        top: 25,
                        child: Image.asset('assets/images/naked/z650.png'))
                  ],
                ),
              ),
              SizedBox(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build("Rear Brake Size     -", "      200 mm"),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  7,85,701", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  7,66,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  7,05,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 7,85,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 7,03,911", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 7,16,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
