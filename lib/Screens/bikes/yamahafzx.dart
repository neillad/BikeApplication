...
class yamahafzx extends StatefulWidget {
  const yamahafzx({Key? key}) : super(key: key);

  @override
  _yamahafzxState createState() => _yamahafzxState();
}

class _yamahafzxState extends State<yamahafzx> {
  @override
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  1,38,701", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "-  1,46,430", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "-  1,33,250", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 1,38,761", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 1,35,911", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 1,35,131", Colors.purple),
                        ]),
                  ],
                ),
              ),
