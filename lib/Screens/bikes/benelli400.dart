...
class benelli400 extends StatelessWidget {
  const benelli400({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build(
                            "Max Power            -    ", "20.7 bhp @6,000rpm"),
                        rich_text_build(
                            "Max Torque           -    ", "29 Nm @3,500rpm"),
                        rich_text_build(
                            "Cylinders                -             ", "1"),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    rich_text_build("Tachometer            -", "     Analogue"),
                    rich_text_build("Headlight Type      -", "      Halogen"),
                    rich_text_build("Brake/Tail Light   -", "     Bulb"),
                    rich_text_build(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        rich_text_build1(
                            "Mumbai      ", "-  2,53,932", Colors.blue),
                        rich_text_build1(
                            "Bangalore  ", "- 2,45,349", Colors.red),
                        rich_text_build1(
                            "Delhi           ", "- 2,25,649", Colors.green),
                      ],
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          rich_text_build1(
                              "Pune      ", "- 2,53,905", Colors.orange),
                          rich_text_build1(
                              "Chennai ", "- 2,25,625", Colors.yellow),
                          rich_text_build1(
                              "Kolkata  ", "- 2,30,336", Colors.purple),
                        ]),
                  ],
                ),
              ),
